...
//*****************************************************************************
CWslString CWslMD5::GetMD5(BYTE* pBuf, UINT nLength)
{
	ASSERT(pBuf);
	CWslMD5 m;
	m.Update(pBuf, nLength );
	return m.Final();
}

//*****************************************************************************
CWslString CWslMD5::GetMD5(const CWslString& s)
{
	CWslMD5 m;
	m.Update((BYTE*)(const char*)s, s.GetLength());
	return m.Final();
}

//*****************************************************************************
CWslString CWslMD5::GetMD5(const char* pcsz)
{
	ASSERT(pcsz);
	CWslMD5 m;
	m.Update((BYTE*)pcsz, strlen(pcsz));
	return m.Final();
}
...
//*****************************************************************************
DWORD CWslMD5::RotateLeft(DWORD x, int n)
{
...
NOTES:			None
*****************************************************************************************/
void CWslMD5::FF( DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD F = (B & C) | (~B & D);
	A += F + X + T;
	A = RotateLeft(A, S);
...
NOTES:			None
*****************************************************************************************/
void CWslMD5::GG( DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD G = (B & D) | (C & ~D);
	A += G + X + T;
	A = RotateLeft(A, S);
...
NOTES:			None
*****************************************************************************************/
void CWslMD5::HH( DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD H = (B ^ C ^ D);
	A += H + X + T;
	A = RotateLeft(A, S);
...
NOTES:			None
*****************************************************************************************/
void CWslMD5::II( DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T)
{
	DWORD I = (C ^ (B | ~D));
	A += I + X + T;
	A = RotateLeft(A, S);
...
*****************************************************************************************/
void CWslMD5::ByteToDWord(DWORD* Output, BYTE* Input, UINT nLength)
{
	//entry invariants
	ASSERT( nLength % 4 == 0 );
...
*****************************************************************************************/
void CWslMD5::Transform(BYTE Block[64])
{
...
*****************************************************************************************/
void CWslMD5::DWordToByte(BYTE* Output, DWORD* Input, UINT nLength )
{
	//entry invariants
	ASSERT( nLength % 4 == 0 );
...
CWslString CWslMD5::Final()
{
	...
	//Convert the hexadecimal checksum to a CWslString
	CWslString strMD5;
...
*****************************************************************************************/
void CWslMD5::Update( BYTE* Input,	ULONG nInputLen )
{
